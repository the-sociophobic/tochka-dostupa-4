...
class App extends Component {
  constructor(props) {
    ...
    this.state = {
      ...
      headerLinks: [
        ...
        { address: "visit", label: ["практическая информация", "visiting"] },
      ...
      fichers: [
        {
          id: 0,
          name: ["Режиссерская лаборатория «Культурный герой XXI»", "Director's labratory «Cultural hero XXI»"],
          place: ["Библиотека Аалто", "Aalto library"],
      ...
      spekts: [
        {
          ...
          placeDesc: ["Спектакль вокруг театров", "Show around theaters"],
          metro: ["м. Маяковская/Площадь восстания, м. Гостиный двор/Невский проспект", "Mayakovskaya station, Gostiny Dvor station"],
        ...
        },
        {
          ...
          place: ["Спектакль в торговом комплексе", "Perfomance in the Mall"],
          ...
          category: 0,
          additionalTitleText: ["Совместно с Гёте\u2011институтом в Санкт\u2011Петербурге", "in partnership with Gorthe\u2011Institut St. Petersburg"],
          banner: {
            img: "marat.jpg",
          ...
          team: [
            ...
            },
            {
              ...
              people: [["Соня Дымшиц", "Sonia Dymshits"], ["Анастасия Балуева", "Anastasia Balyeva"], ["засл.арт.РФ Сергей Лосев", "Sergey Losev"], ["Гала Самойлова", "Gala Samoilova"], ["Даша Степанова", "Daria Stepanova"], ["Олег Федоров", "Oleg Fedorov"]]
            },
          ],
        ...
        {
          id: 3,
          name: ["Музей инопланетного вторжения", "Alien invasion museum"],
        ...
        },
        {
          ...
          by: ["Творческая лаборатория «Угол» (Казань)", "Creative lab Ugol (Kazan)"],
          place: "",
        ...
        {
          id: 5,
          name: ["Трехгоршковая опера", "The chamber pot opera"],
          by: ["Театральная компания Bontom (Сидней, Австралия)", "Theatre company Bontom (Sydney, Australia)"],
          place: ["Спектакль в отеле Hilton Saint Petersburg ExpoForum", "Perfomance in «Hilton Saint Petersburg ExpoForum» hotel"],
          address: ["Петербургское шоссе, 62 к1", "Hilton ExpoForum, Peterburgskoye hw., 62"],
          ...
          team: [
            ...
            {
              label: ["Музыкальный руководитель", "Music Director"],
              people: [["Кейрен Брандт-Соуди", "Darci Gayford"], ]
            },
            {
              label: ["Музыкальное оформление", ""],
              people: [["Дарси Гэйфорд", ""], ]
            },
            {
              label: ["В ролях", "Actors"],
            ...
            },
            {
              ...
              people: [["Michelle Sverdloff", "Мишель Свердлофф"], ]
            },
          ],
        ...
        },
        {
          ...
          mapDescription: ["Ближайшая станция метро — «Площадь восстания»", "Nearest metro station «Ploschad\' Vosstaniya»"],
          metro: "«Ploschad\' Vosstaniya» metro station",
          age: 12,
          duration: ["2 часа", "2 hours"],
          category: 2,
          partners: [],
      ...
      partners: [
        ...
        },
        {
          ...
          // img: "td.png",
          img: "01_std@1.png",
          label: ["Союз Театрльных Деятелей Российской федерации", "Union of Theatre Workers of the Russian Federation"],
          link: "http://stdrf.ru/",
        },
        {
          id: 2,
          ...
          labelSpekt: ["Гёте-институт в Санкт-Петербурге", "Goethe Institut in St. Petersburg"],
        ...
        },
        {
          ...
          // label: "при поддержке",
          labelSpekt: "Швейцарский совет по культуре",
        ...
        },
        {
          ...
          labelSpekt: "Технологический партнёр",
        ...
        },
        {
          ...
          img: "11_btk@1.png",
          label: "",
          labelSpekt: "Большой Театр Кукол",
        ...
        },
        {
          ...
          label: "",
          labelSpekt: "Новая Сцена Александринского Театра",
        ...
        },
        {
          ...
          label: "",
          labelSpekt: "Швейцарское Посольство в России",
      ...
      workers: [
        ...
        {
          name: ["Андрей Пронин", ""],
          title: ["Программный директор", ""],
          site: "",
        },
        {
          name: ["Ольга Аршанская", ""],
          title: ["Заместитель директора фестиваля", ""],
          site: "https://vk.com/id532781",
        },
        {
          name: ["Ксения Малекина", ""],
          title: ["Руководитель продюсерской службы", ""],
          site: "https://vk.com/malekina",
        },
        {
          name: ["Дарья Назаркина", ""],
          title: ["Главный администратор продюсерской службы", ""],
          site: "https://vk.com/id978095",
        },
        {
          name: ["Анастасия Грекова", ""],
          title: ["Заместитель руководителя продюсерской службы", ""],
          site: "https://vk.com/anastasia.grekova",
        },
        {
          name: ["Ксения Евдокимова", ""],
          title: ["Координатор проектов", ""],
          site: "https://vk.com/nalur",
        },
        {
          name: ["Оксана Преснякова", ""],
          title: ["Координатор проектов", ""],
          site: "https://vk.com/id445523",
        },
        {
          name: ["Екатерина Венедиктова", ""],
          title: ["Координатор проектов", ""],
          site: "https://vk.com/eaven",
        },
        {
          name: ["Екатерина Теплова", ""],
          title: ["Руководитель службы гостепреимства фестиваля", ""],
          site: "",
        },
        {
          name: ["Антон Москалёв", ""],
        ...
        },
        {
          ...
          title: ["Ассистент проекта", ""],
          site: "https://vk.com/id30152702",
        },
        {
          name: ["Елизавета Готсдинер", ""],
          title: ["Координатор волонтёрского движения", ""],
          site: "https://vk.com/lost_lizard",
        },
        {
          name: ["Артём Арсенян", ""],
          title: ["Директор по маркетингу и коммуникациям", ""],
        ...
        {
          name: ["Николай Филиппов", ""],
          title: ["Дизайнер", ""],
          site: "https://vk.com/the_simple_colours",
        },
        {
          name: ["Полина Назарова", ""],
          title: ["Фотограф", ""],
  ...
  renderIndexPage() {
    ...
    var textStyle = {
      ...
      fontSize: (H / W > 0.7 ? W / 11 : (Math.pow(W * H, 0.452) * (W / H > 20 / 9 ? 0.21 : 0.22))) + "px"
    };
    ...
    var textStyleMobile = {
      ...
      // fontSize: (H / W > 1.2 ? W / 11 : (Math.pow(W * H, 0.459) * (W / H > 20 / 9 ? (W < 340 || H < 340 ? 0.1 : 0.12) : (W < 340 || H < 340 ? 0.118 : 0.133)))) + "px"
      fontSize: (H / W > 1.2 ? W / 11 : (Math.pow(W * H, 0.459) * (W / H > 20 / 9 ? (W < 340 || H < 340 ? 0.12 : 0.14) : (W < 340 || H < 340 ? 0.138 : 0.153)))) + "px"
    };
    ...
    var codeText = (this.state.lang ? "fourth international summer festival of arts" : "четвертый международный летний фестиваль искусств").split("").map(letter =>
  ...
  renderSchedulePage() {
    ...
    var filterButtons = [
      ...
      {
        id: 1,
        label: (this.state.lang ? "Touring program" : "Гастрольная программа"),
      },
      {
        id: 2,
      ...
      <button
        ...
        onClick={() => {this.setState({scheduleFilter: button.id})}}
      >
  ...
  renderVisitPage() {
    document.title = this.state.lang ? "Точка доступа: Практическая информация" : "The Access Point: Visiting";
    ...
    return (
      <div className="visit">
        <h1 id="visit-title">{this.state.lang ? "Visiting" : "Практическая информация"}</h1>
        <article id="visit-navigation">
          {navigationLinks}
        </article>
        <article id="visit-navigation" className={"fixed " + (this.state.navigationFixed && !this.state.mobile ? "visible" : "invisible")}>
  ...
  renderFestivalPage() {
    ...
    var workersMapped = workers.map(worker =>
  ...
  renderPartnersPage() {
    ...
    var blocks4 = [
      ...
      (this.state.lang ? "Co-organizer" : "Соорганизатор"), 2, (this.state.lang ? "Support by" : "При поддержке"), 3,
      ...
      (this.state.lang ? "Information partners" : "Информационные партнёры"), 29, 26, 25,
      null, 21, 20, 22,
      null, 34, 24, 27,
      null, 28, null, null,
    ...
    var blocks3 = [
      ...
      (this.state.lang ? "Co-organizer" : "Соорганизатор"), 2, null,
      ...
      (this.state.lang ? "Information partners" : "Информационные партнёры"), 29, 26,
      null, 25, 21,
      null, 20, 22,
      null, 34, 24,
      null, 27, 28,
  ...
  render() {
    ...
    var headerLinks = this.state.headerLinks.map(link =>
    ...
    var headerLinksMobile = this.state.headerLinks.map(link =>
      <Link to={"/" + link.address} onClick={() => this.setPage()}>
...
function recursiveTimeOut(func, ms, iterations = 50) {
  // if (iterations > 50)
  //   return;
  setTimeout(() => {
    func();
